...
public interface BemCandidatoRepository extends JpaRepository<BemCandidato, Long> {
    ...
    @Query("SELECT DISTINCT new br.org.faetectcc2018.dto.TipoBemDTO(bem.cdTipoBemCandidato, bem.dsTipoBemCandidato) FROM BemCandidato bem ORDER BY bem.dsTipoBemCandidato")
